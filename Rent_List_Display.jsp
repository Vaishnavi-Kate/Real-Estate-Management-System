<%@ page language="java" import="com.DbConnect,java.sql.*" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1"%>
<!DOCTYPE html>
<html>
<head>
<!-- Basic Page Needs ================================================== -->
<title>Search My Home</title>
	...
	<meta name="keywords" content="Search my home latur, Rent, Properties">
...
<div class="container">
	<div class="row sticky-wrapper">
		<div class="col-md-8">
			...
			<!-- Listings -->
			<div class="listings-container list-layout" id="DisplayRentResults">

			<%
			PreparedStatement ps = DbConnect.getCon().prepareStatement("SELECT * FROM tblrent_properties");
...
<!-- 					<div class="listing-footer">
		...
		<!-- Sidebar -->
		<jsp:include page="Rent_Side_Bar.jsp"></jsp:include>
...
$(document).ready(function(){
 ...
 $('form').on('submit',function(e){
	 ...
	 $.ajax({
		 type:'POST',
		 url:'Get_Rent_Result.jsp',
		 data:$('form').serialize(),
		 success:function(result){
			 $('#DisplayRentResults').html(result);
		 }
	 });
 });
});
