<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" import="java.sql.*,com.DbConnect"%>
				...
				<div class="widget margin-bottom-40">
					...
					<div class="row with-forms">
						...
						<div class="col-md-12">
							<select data-placeholder="Any Type" name="Property_Category" class="chosen-select-no-single" >
								...
								<%
								sql = "SELECT distinct(Property_Category) FROM tblbuy_properties;";
					...
					<div class="row with-forms">
						...
						<div class="col-md-12">
							<select data-placeholder="All Cities" name="Cities" class="chosen-select" >
								...
								<%
								sql = "SELECT distinct(City) FROM tblbuy_properties;";
								ps = DbConnect.getCon().prepareStatement(sql);
								rs = ps.executeQuery();
					...
					<div class="row with-forms">
						...
						<div class="col-md-6">
							<select  class="chosen-select-no-single" name="Prop_Type">
								...
								<%
								sql = "SELECT distinct(Property_type) FROM tblbuy_properties;";
								ps = DbConnect.getCon().prepareStatement(sql);
								rs = ps.executeQuery();
						...
						<div class="col-md-6">
							<select class="chosen-select-no-single" name="Bath">
								...
								<%
								sql = "SELECT distinct(No_Of_Bathrooms) FROM tblbuy_properties";
								ps = DbConnect.getCon().prepareStatement(sql);
								rs = ps.executeQuery();
					...
					<div class="range-slider">
						<label>Area Range</label>
							<%
								sql = "SELECT max(Builtup_Area) as maxarea FROM tblbuy_properties";
								ps = DbConnect.getCon().prepareStatement(sql);
								rs = ps.executeQuery();
								int max=0;
					...
					<div class="range-slider">
					<%
								sql = "SELECT max(Price) as maxprice FROM tblbuy_properties";
								ps = DbConnect.getCon().prepareStatement(sql);
								rs = ps.executeQuery();
								int maxprice=0;
						...
						<div id="price-range" data-min="0" data-max="<%=maxprice %>" data-unit="RS."></div>
						<div class="clearfix"></div>
					</div>
					...
					<a style="margin-top:25px" href="Buy_List_Display.jsp">Reset All Attributes</a>
				</div>
				<!-- Widget / End -->
