				...
				<div class="widget margin-bottom-40">
					...
					<div class="row with-forms">
						...
						<div class="col-md-12">
							<select data-placeholder="Any Type" name="Property_Category" class="chosen-select-no-single" >
								...
								<%
								sql = "SELECT distinct(Property_Category) FROM tblrent_properties;";
					...
					<div class="row with-forms">
						...
						<div class="col-md-12">
							<select data-placeholder="All Cities" name="Cities" class="chosen-select" >
								...
								<%
								sql = "SELECT distinct(City) FROM tblrent_properties;";
								ps = DbConnect.getCon().prepareStatement(sql);
								rs = ps.executeQuery();
					...
					<div class="row with-forms">
						...
						<div class="col-md-6">
							<select  class="chosen-select-no-single" name="Prop_Type">
								...
								<%
								sql = "SELECT distinct(Property_type) FROM tblrent_properties;";
								ps = DbConnect.getCon().prepareStatement(sql);
								rs = ps.executeQuery();
						...
						<div class="col-md-6">
							<select class="chosen-select-no-single" name="Bath">
								...
								<%
								sql = "SELECT distinct(No_Of_Bathrooms) FROM tblrent_properties;";
								ps = DbConnect.getCon().prepareStatement(sql);
								rs = ps.executeQuery();
					...
					<div class="range-slider">
						<label>Area Range</label>
											<%
								sql = "SELECT max(Builtup_Area) as maxarea FROM tblrent_properties";
								ps = DbConnect.getCon().prepareStatement(sql);
								rs = ps.executeQuery();
								int max=0;
					...
					<div class="range-slider">
					<%
								sql = "SELECT max(Rent) as maxarea FROM tblrent_properties";
								ps = DbConnect.getCon().prepareStatement(sql);
								rs = ps.executeQuery();
								int maxrent=0;
