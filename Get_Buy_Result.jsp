...
try
{
	...
	String sql = "SELECT * FROM tblbuy_properties where Property_Category like ? and Property_Type like ? and Builtup_Area between ? and ? and No_Of_Bathrooms like ? and Price between ? and ? and City like ? and Lift like ? and Borewell like ? and Generator like ? and Playground like ? and Balconies like ?";
