...
@javax.servlet.annotation.WebServlet({"/Upload_Add_Property_Buy_Images"})
public class Upload_Add_Property_Buy_Images extends HttpServlet
{
  File i4;
  File i3;
  File i2;
  ...
  public Upload_Add_Property_Buy_Images() {}
  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, java.io.IOException
  {
    ...
    String path = "E:\\Project_Workspace\\SearchMyHomeProj\\WebContent\\Buy_Property_images\\";
    ...
    try
    {
      String sql = "update tblbuy_properties set Pic1=?, pic2=?, Pic3=?, Pic4=? where Property_Id=?";
      ...
      if (check > 0)
      {
        ...
        out.print("<script>");
        out.print("alert('Successfully Uploaded Images..'); location.href='Add_Property_Buy.jsp';");
        out.print("</script>");
      }
      else
      {
        out.print("<script>");
        out.print("alert('Try Later'); location.href='Upload_Add_Property_Buy_Images.jsp';");
        out.print("</script>");
      }
    }
    catch (Exception e)
