...
try
{
	String sql = "SELECT * FROM tblpg_hostel_properties where Property_Category like ? and Property_Type like ? and Builtup_Area between ? and ? and No_Of_Bathrooms like ? and Rent between ? and ? and City like ? and Lift like ? and Borewell like ? and Generator like ? and Playground like ? and Balconies like ?";
		...
		<!-- Listing Item -->
				<div class="listing-item">
					...
					<a href="Property_page.jsp?PropHostelId=<%=rs.getString(2) %>" class="listing-img-container">
						...
						<img src="Pg_Hotel_Property_images/<%=rs.getString(23) %>" alt="">
